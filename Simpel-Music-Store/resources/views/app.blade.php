...
<body class="mt-20">
    ...
    <div class="absolute top-0 left-0 w-full h-full flex flex-col items-center mt-4 sm:mt-25 space-y-4">
        ...
        <button type="button" class="rounded-md bg-black px-3.5 py-2.5 sm:px-4.5 sm:py-3.5 text-sm font-semibold border-1 text-[#F4D468] shadow-sm hover:bg-[#1b1b1acc]">Bekijk onze collecties</button>
    </div>
</div>
